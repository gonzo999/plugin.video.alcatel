...
Base = 'http://lacuevadelsaber1.blogspot.mx/2016/11/raanubis.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.alcatel') #    modificar("el nombre de tu addons")
